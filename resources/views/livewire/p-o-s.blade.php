<div class="flex h-screen bg-gray-100 dark:bg-neutral-900 font-sans antialiased text-gray-800 dark:text-gray-100">
    ...
    <div
        ...
        <div class="flex-shrink-0 mt-6 space-y-4">
            <div class="space-y-2">
                <div>
                    ...
                    <select wire:model="customerId" id="customer"
                ...
                <div>
                    ...
                    <select wire:model="paymentMethodId" id="payment-method"
                        class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm 
                            focus:border-blue-500 focus:ring-blue-500 
                            dark:bg-neutral-900 dark:border-neutral-700 
                            dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
            ...
            <div class="mt-4">
                <label for="discount" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Discount
                    Amount</label>
                <input wire:model.live.blur="discountAmount" type="number" id="discount" min="0"
        ...
        <div class="flex-shrink-0 mt-6">
            <input wire:model.live.blur="paidAmount" type="number" min="0" placeholder="Amount Paid"
                class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm 
